...
class Distribution(object):
    ...
    def __add__(self, other: "Distribution") -> "Distribution":
        return Distribution(_combine_dictionaries(self.dist, other.dist, lambda a, b: a + b))
    ...
    def __neg__(self) -> "Distribution":
        return Distribution({-v: k for v, k in self.dist.items()})
    ...
    def __deepcopy__(self) -> "Distribution":
        return Distribution(copy.deepcopy(self.dist))
